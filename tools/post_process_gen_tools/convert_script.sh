...
CLASSES=25
MODEL_NAME=yolov9_${TYPE}_wholebody${CLASSES}${RELUS}${QATS}
SUFFIX="0100_1x3x"
...
do
    ...
    --srcop_destop scores gn_scores selected_indices gn_selected_indices \
    ...
    sor4onnx \
    --input_onnx_file_path 18_nms_yolov9_${BOXES}.onnx \
    --old_new "/Concat" "p/Concat" \
    --output_onnx_file_path 18_nms_yolov9_${BOXES}.onnx \
    --mode full
    ...
    if [ -z ${QAT} ]; then
        ...
        --srcop_destop output boxes_scores_input \
    ...
    sor4onnx \
    --input_onnx_file_path ${MODEL_NAME}_post_${SUFFIX}${H}x${W}.onnx \
